...
export const AppInput = ({input,inputChange,title,returnKeyType,onSubmitEditing,inputStyle,textStyle,containerStyle,secureTextEntry,reqired,placeholder,autoFocus}) => {
