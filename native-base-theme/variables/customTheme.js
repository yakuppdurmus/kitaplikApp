...
export default {
  ...
  // Button
  buttonFontFamily: platform === "ios" ? 'Montserrat-Bold' : 'Montserrat-Bold',
  ...
  // Font
  DefaultFontSize: 16,
  fontFamily: platform === "ios" ? 'Montserrat-Regular' : 'Montserrat-Regular',
  fontSizeBase: 15,
  get fontSizeH1() {
  ...
  activeTab: platform === "ios" ? 'red' : 'red',
  sTabBarActiveTextColor: 'red',
  tabBarActiveTextColor: platform === "ios" ? 'red' : 'red',
  ...
  // Title
  titleFontfamily: platform === "ios" ? 'Montserrat-Regular' : 'Montserrat-Regular',
